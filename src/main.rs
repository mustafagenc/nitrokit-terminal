...
fn show_menu() {
    ...
    println!("  {} {}", "3. 🌍 sync-translations".green(), "Sync translations using Gemini AI");
    println!("  {} {}", "4. ⚙️  config".blue(), "Manage configuration settings");
    println!("  {} {}", "5. ❓ help".blue(), "Show this help menu");
    println!("  {} {}", "6. 🚪 exit".red(), "Exit Nitrokit");
    println!();
}
    ...
    let app = Command::new("nitrokit")
        ...
        .subcommand(
            Command::new("config")
                ...
                .subcommand(Command::new("setup").about("Setup configuration interactively"))
    ...
    loop {
        ...
        match input.as_str() {
            ...
            "5" | "help" => {
                ...
                println!("  {} - Sync translations using Gemini AI", "🌍 sync-translations".green());
                ...
                println!("  {} {}", "Sync translations:".dimmed(), "nitrokit sync-translations");
                println!("  {} {}", "Config management:".dimmed(), "nitrokit config show");
            ...
            _ => {
                ...
                println!("{}", "Please choose a valid option (1-6) or type the command name.".dimmed());
